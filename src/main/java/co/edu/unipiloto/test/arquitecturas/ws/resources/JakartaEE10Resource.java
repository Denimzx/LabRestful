...
public class JakartaEE10Resource {
    ...
    static {
        for (int i = 0; i < 10; i++) {
            ...
            persona.setEdad(new Random().nextInt(20+id));
            persona.setSalario(persona.getEdad()*Persona.SalarioMinimo/3);
    ...
    public List<Persona> agregarPersona(List<Persona> pr) {
